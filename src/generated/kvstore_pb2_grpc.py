...
class KeyValueServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSnapshot = channel.unary_unary(
                '/KeyValueService/GetSnapshot',
                request_serializer=kvstore__pb2.GetSnapshotRequest.SerializeToString,
                response_deserializer=kvstore__pb2.GetSnapshotResponse.FromString,
                _registered_method=True)
        self.Ping = channel.unary_unary(
                '/KeyValueService/Ping',
...
def add_KeyValueServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSnapshot': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=kvstore__pb2.GetSnapshotRequest.FromString,
                    response_serializer=kvstore__pb2.GetSnapshotResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('KeyValueService', rpc_method_handlers)
...
class KeyValueService(object):
    ...
    def GetSnapshot(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/KeyValueService/GetSnapshot',
            kvstore__pb2.GetSnapshotRequest.SerializeToString,
            kvstore__pb2.GetSnapshotResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
